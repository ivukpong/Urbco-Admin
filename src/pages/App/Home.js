          ...
          <div className="move">
            <div className="row">
              <div className="col-lg-4 col-md-6 col-6 mb-3">
                <div
                  className="box"
                  onClick={() => navigate("/dashboard/accounts/users")}
                >
                  <div>
                    <FiUser />
                    <p>Users</p>
                  ...
                  <h4>
                    {typeof stats.users === "number" ? `${stats.users}` : "--"}
                  </h4>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-6 mb-3">
                <div
                  className="box"
                  onClick={() => navigate("/dashboard/accounts/investors")}
                >
                  <div>
                    <FiUser />
                    <p>Investors</p>
              ...
              <div className="col-lg-4 col-md-6 col-6 mb-3">
                <div
                  className="box"
                  onClick={() => navigate("/dashboard/accounts/roles")}
                >
                  <div>
                    <FiAlertTriangle />
                    <p>Roles</p>
                  ...
                  <h4>
                    {typeof stats.users === "number" ? `${stats.roles}` : "--"}
                  </h4>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-6 mb-3">
              ...
              <div className="col-lg-4 col-md-6 col-6 mb-3">
                <div
                  className="box"
                  onClick={() => navigate("/dashboard/basic/features")}
                >
                  <div>
              ...
              <div
                ...
                onClick={() => navigate("/dashboard/payments/investments")}
              >
                <div className="box">
                  <div>
                    <MdOutlineFeaturedPlayList />
              ...
              <div className="col-lg-4 col-md-6 col-6 mb-3">
                <div
                  className="box"
                  onClick={() => navigate("/dashboard/payments/transactions")}
                >
                  <div>
                    <MdOutlineFeaturedPlayList />
