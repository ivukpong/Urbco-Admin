...
import { listRequests } from "../../redux/users/userSlice";
...
const Requests = () => {
  ...
  }, [pageNumber, dispatch, user_details.access_token]);

  return (
    <div className="table-div mt-5">
      <div className="head">
        <h5>List of Users requesting for information about a property</h5>
      </div>
              ...
              <table className="table table-bordered">
                ...
                <tbody>
                  {requests.requests.map((user) => (
                    <tr key={user._id}>
                      <td className="wide">{user.name}</td>
